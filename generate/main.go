...
//
// [GitHub]: https://github.com/HwangTaehyun/genqlient
package generate
...
See https://github.com/HwangTaehyun/genqlient for full documentation.
`)
}

// Main is the command-line entrypoint to genqlient; it's equivalent to calling
//
//	go run github.com/HwangTaehyun/genqlient
//
